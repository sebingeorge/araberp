       ...
       /// <returns></returns>
        ...
        public Item InsertItem(Item objItem)
        {
            ...
            using (IDbConnection connection = OpenConnection(dataConnection))
            {
                ...
                string sql = @"insert  into Item(ItemRefNo,PartNo,ItemName,ItemPrintName,ItemShortName,ItemGroupId,ItemSubGroupId,ItemCategoryId,ItemUnitId,MinLevel,ReorderLevel,MaxLevel,BatchRequired,StockRequired,CriticalItem,OrganizationId,CreatedBy,CreatedDate) Values
                                            (@ItemRefNo,@PartNo,@ItemName,@ItemPrintName,@ItemShortName,@ItemGroupId,@ItemSubGroupId,@ItemCategoryId,@ItemUnitId,@MinLevel,@ReorderLevel,@MaxLevel,@BatchRequired,@StockRequired,@CriticalItem,@OrganizationId,@CreatedBy,@CreatedDate);
